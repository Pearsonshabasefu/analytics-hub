        ...
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-5 gap-10">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/compliance" className="hover:text-zinc-300 transition-colors">Trust & Compliance Center</Link></li>
              <li>
                <button
                  type="button"
                  onClick={() => window.dispatchEvent(new CustomEvent('refineiq-open-cookie-preferences'))}
                  className="hover:text-zinc-300 transition-colors text-left"
                >
                  Cookie Preferences
                </button>
              </li>
